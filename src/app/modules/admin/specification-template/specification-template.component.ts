...
import { productManagementResponseData } from './specification-template.type';
...
@Component({
  selector: 'app-specification-template',
  templateUrl: './specification-template.component.html',
  styleUrls: ['./specification-template.component.scss'],
})
export class SpecificationTemplateManagementComponent implements OnInit {
